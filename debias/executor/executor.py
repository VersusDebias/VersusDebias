...
if __name__ == "__main__":
    # prompt_path = '/data/hanjun/BIGbenchold/prompt/implicit/char.txt'
    prompt_path = '/data/hanjun/BIGbenchold/prompt/implicit/oc.txt'
    new_prompt_path = 'new_prompt_path.txt'
    element_path = '/data/hanjun/executor_haoyu_test/element.txt'
    file_path = 'best_result.json'  # json file\
    path = '/data/hanjun/VersusDebias/model/minicpm-executor' # Model path
    # path = '/data/hanjun/VersusDebias/model/minicpm-executor2'
    occupations_list = read_occupations(element_path)
    data = read_data(file_path)
    #for test
    # find_occupation_json("manager", data)
    if data:
        print("load prompt")
    else: 
        print("can't load json")
        ...
        for line in file_read:
            ...
            if match:
                ...
                if(s == 1):
                    ...
                    occupation_q3 = s[0]
                    original_occupation = s[1]
                    # print(f"occupation_q3: {occupation_q3.lower()}")
                    if(occupation_q3.lower() in occupations_list):
                        # print(f"occupationq3 is {occupation_q3}")
                        attribute = find_occupation_json(occupation_q3, data)
